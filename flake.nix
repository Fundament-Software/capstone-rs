{
  ...
  outputs =
    ...
    in
    rec {
      devShells.default = (pkgs.mkShell.override { stdenv = pkgs.stdenvAdapters.useMoldLinker pkgs.llvmPackages_23.stdenv; }) {
      ...
      checks =
        let
          ...
          commonArgs = {
            ...
            strictDeps = true;
            version = "0.1.0";
            stdenv = pkgs: pkgs.stdenvAdapters.useMoldLinker pkgs.llvmPackages_23.stdenv;
